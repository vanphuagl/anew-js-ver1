        ...
        <div className={styles.overviewLeft}>
          <div className={styles.overviewTop}>
            ...
            <div className={styles.desc}>
              <p>
                最短約３ヶ月で分解されて土に還るジンカップのプロトタイプ。YOKOGAWA の協力のもと VASU
                ...
                DIY する」過去に例がない手法を選んだ。伊勢丹新宿店での「大東京展覧会 Tour of Asia Akihiro Wood Works in
                Tokyo」にてお披露目。素材や金型の
                <a
          ...
          <div className={styles.overviewBottom}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.desc}>
                プロダクトサステナビリティの観点から「私たちはいかにしてよき祖先となれるか」というグッドアンセスターとしての可能性を追求するプロジェクトチーム。
