          ...
          <div className={styles.overviewTop}>
            ...
            <div className={styles.desc}>
              {props.language === 'jp' ? (
                ...
                <p className={`${styles.en} sansserif-fonts`}>
                  A prototype of jincup that decomposes in the soil in approximately 3 months(At the shortest). With the
                  cooperation of YOKOGAWA, VASU Japan’s biodegradable plastic material was molded into block form by
                  Nissili, then delivered to Kagoshima where Jin Akihiro hand-carved them to create the cup. Given the
                  high cost of creating molds required in the manufacturing process of plastic products, a previously
                  unheard-of method of “DIY plastic” was chosen for the first sample, pouring the material into existing
                  molds and carving the blocks with woodworking chisels to shape them. This was showcased at the&nbsp;"
                  <a
                    href='https://www.mistore.jp/store/shinjuku/shops/living/park/shopnews_list/shopnews_059.html'
                    target='_blank'
                    rel='noopener noreferrer'
                  ...
                  "&nbsp;exhibition at Isetan Shinjuku Store. Verification of materials and mold issues is underway, as
                  efforts continue to productize the cups.
                </p>
              )}
            </div>
          </div>
          ...
          <div className={styles.overviewBottom}>
            <div className={styles.content}>
              ...
              {props.language === 'jp' ? (
                ...
                <p className={`${styles.desc} ${styles.en} sansserif-fonts`}>
                  A woodworking artist based in Kagoshima. From straight lines to curves, from curves to surfaces, his
                  powerful three-dimensional constructions draw viewers into his works. Since starting activities in
                  2002, he has expanded his range of activities from custom furniture production, development of
                  original product lines, to installations, in addition to store and residential interior design.
                </p>
              )}
            ...
            <div className={styles.content}>
              ...
              {props.language === 'jp' ? (
                ...
                <p className={`${styles.desc} ${styles.en} sansserif-fonts`}>
                  A project team that explores the potential of being “good ancestors” from the perspective of product
                  sustainability. Starting from considerations of environmental crises, culture, and economics, they
                  conduct research on design and materials related to products, developing products with low
                  environmental impact suitable for future societies.
                </p>
              )}
