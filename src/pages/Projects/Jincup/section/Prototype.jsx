            ...
            <div className={styles.prototypeLink}>
              <a href='https://www.yokogawa.com/jp-ybf/' target='_blank' rel='noreferrer'>
                ...
                >
                  <defs>
                    <clipPath id='a'>
                      <rect width='137.941' height={35} fill='none' />
                    </clipPath>
                  </defs>
                  <g transform='translate(0 0)'>
                    <rect width='137.941' height={35} transform='translate(0 0)' fill='#004f9b' />
                    <g transform='translate(0 0)'>
                      <g clipPath='url(#a)'>
                        <path
                          d='M320.884,41.735a21.6,21.6,0,0,1,8.958-9.248c0,.011-8.948-8.948-8.948-8.958-4.482,4.49-7.127,7.109-8.958,8.958,0,0,.018.01,0,0a21.645,21.645,0,0,1,8.948,9.248'
                          transform='translate(-198.655 -14.985)'
                          fill='#fe0'
                        />
                        <path
                          d='M28.691,43.319H26.663V37.855L21.126,30h2.569l3.97,5.889,4-5.882H34.2l-5.511,7.8Z'
                          transform='translate(-13.454 -19.108)'
                          fill='#fff'
                        />
                        <path
                          d='M58.683,28.905c-1,0-6.519.447-6.519,7.158a6.506,6.506,0,0,0,6.581,6.91c1.113.008,6.564-.642,6.564-7.077,0-6.1-4.906-6.99-6.626-6.99m.137,12.312c-1.97,0-4.6-1.15-4.6-5.294,0-3.786,2.5-5.291,4.472-5.291,1.8,0,4.55,1.177,4.55,5.465,0,4.212-3.033,5.121-4.424,5.121'
                          transform='translate(-33.22 -18.408)'
                          fill='#fff'
                        />
                        <path
                          d='M93.157,43.3H91.138V29.985l2.143.007v6.3l6.277-6.3h2.757l-5.538,5.556L102.75,43.3l-2.6.009-4.932-6.523-2.066,1.954Z'
                          transform='translate(-58.041 -19.096)'
                          fill='#fff'
                        />
                        <path
                          d='M124.6,28.812c-1.924.067-6.708,1.05-6.708,6.943,0,6.49,5.176,7.146,6.767,7.137,1.781-.011,6.437-1.253,6.459-7.087.027-6.989-6.6-6.99-6.519-6.993m-.013,12.331c-1.927,0-4.575-1.032-4.575-5.287,0-4.062,2.659-5.29,4.529-5.29,2.347,0,4.445,1.738,4.445,5.2,0,4.477-2.843,5.374-4.4,5.374'
                          transform='translate(-75.078 -18.349)'
                          fill='#fff'
                        />
                        <path
                          d='M163.263,35.714l5.769.006-.018,6.936h-1.6l-.233-1.285a5.694,5.694,0,0,1-4.514,1.638c-2.907-.005-6.088-2.317-6.088-7.055,0-3.22,2.043-6.9,6.318-6.884,2.263,0,5.415.755,5.952,4.26l-2.093.006a3.471,3.471,0,0,0-3.686-2.606c-2.182,0-4.343,1.33-4.343,5.382,0,3.833,2.4,5.251,4.238,5.251,1.8,0,3.5-.612,4.182-3.813h-3.879Z'
                          transform='translate(-99.719 -18.513)'
                          fill='#fff'
                        />
                        <path
                          d='M198.534,30.062l-2.732.006-4.26,13.278h2.182l1.13-3.685,5.206-.006,1.466,3.661,2.233-.021Zm-3.166,7.88,1.812-5.968.389,1.069,1.815,4.9Z'
                          transform='translate(-121.983 -19.145)'
                          fill='#fff'
                        />
                        <path
                          d='M218.425,30.011H220.7c1.786,7.226,2.14,8.494,2.536,9.906.311-1.329.96-3.073,2.712-9.906h2.059c2.075,7.366,2.385,8.5,2.838,9.986.313-1.233.748-2.7,2.522-9.986h2.152l-3.564,13.275-2.131.026c-1.729-5.894-1.939-6.608-2.814-9.713-.718,2.475-.86,3.115-2.709,9.7h-2.191Z'
